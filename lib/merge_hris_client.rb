...
require 'merge_hris_client/models/dependent'
...
require 'merge_hris_client/models/employer_benefit'
...
require 'merge_hris_client/models/paginated_employer_benefit_list'
