...
module MergeHRISClient
  class TeamsApi
    ...
    # @option opts [Team] :team 
    # @return [Team]
    def teams_create(opts = {})
      data, _status_code, _headers = teams_create_with_http_info(opts)
      data
    end
    ...
    def teams_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'team']) 
    ...
    def teams_destroy(id, opts = {})
      data, _status_code, _headers = teams_destroy_with_http_info(id, opts)
      data
    end
    ...
    def teams_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamsApi.teams_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeamsApi.teams_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamsApi#teams_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def teams_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedTeamList' 
    ...
    # @option opts [String] :x_link_token Token identifying the end user.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @option opts [PatchedTeam] :patched_team 
    # @return [Team]
    def teams_partial_update(id, opts = {})
      data, _status_code, _headers = teams_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedTeam] :patched_team 
    # @return [Array<(Team, Integer, Hash)>] Team data, response status code and response headers
    def teams_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamsApi.teams_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeamsApi.teams_partial_update"
      end
      # resource path
      local_var_path = '/teams/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_team']) 
    ...
    # @option opts [String] :x_link_token Token identifying the end user.
    # @return [Team]
    def teams_retrieve(id, opts = {})
      data, _status_code, _headers = teams_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_link_token Token identifying the end user.
    # @return [Array<(Team, Integer, Hash)>] Team data, response status code and response headers
    def teams_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [Team] :team 
    # @return [Team]
    def teams_update(id, opts = {})
      data, _status_code, _headers = teams_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Team] :team 
    # @return [Array<(Team, Integer, Hash)>] Team data, response status code and response headers
    def teams_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamsApi.teams_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeamsApi.teams_update"
      end
      # resource path
      local_var_path = '/teams/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
