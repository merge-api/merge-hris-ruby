...
module MergeHRISClient
  class LocationsApi
    ...
    def locations_list_with_http_info(x_account_token, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedLocationList'
    ...
    def locations_retrieve_with_http_info(x_account_token, id, opts = {})
      ...
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling LocationsApi.locations_retrieve"
      end
      ...
      new_options = opts.merge(
        :operation => :"LocationsApi.locations_retrieve",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
