...
module MergeHRISClient
  class TimeOffApi
    ...
    # @return [TimeOff]
    def time_off_create(opts = {})
      data, _status_code, _headers = time_off_create_with_http_info(opts)
      data
    end
    ...
    def time_off_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'time_off']) 

      # return_type
      return_type = opts[:return_type] || 'TimeOff' 
    ...
    def time_off_destroy(id, opts = {})
      data, _status_code, _headers = time_off_destroy_with_http_info(id, opts)
      data
    end
    ...
    def time_off_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimeOffApi.time_off_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TimeOffApi.time_off_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimeOffApi#time_off_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def time_off_list(opts = {})
      data, _status_code, _headers = time_off_list_with_http_info(opts)
      data
    end
    ...
    def time_off_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimeOffApi.time_off_list ...'
      end
      allowable_values = ["approver", "employee"]
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedTimeOffList' 
    ...
    # @return [TimeOff]
    def time_off_partial_update(id, opts = {})
      data, _status_code, _headers = time_off_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedTimeOff] :patched_time_off 
    # @return [Array<(TimeOff, Integer, Hash)>] TimeOff data, response status code and response headers
    def time_off_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimeOffApi.time_off_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TimeOffApi.time_off_partial_update"
      end
      # resource path
      local_var_path = '/time-off/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_time_off']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimeOffApi#time_off_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [TimeOff]
    def time_off_retrieve(id, opts = {})
      data, _status_code, _headers = time_off_retrieve_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :expand Which relations should be returned in expanded form.
    # @return [Array<(TimeOff, Integer, Hash)>] TimeOff data, response status code and response headers
    def time_off_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [TimeOff] :time_off 
    # @return [TimeOff]
    def time_off_update(id, opts = {})
      data, _status_code, _headers = time_off_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [TimeOff] :time_off 
    # @return [Array<(TimeOff, Integer, Hash)>] TimeOff data, response status code and response headers
    def time_off_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TimeOffApi.time_off_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TimeOffApi.time_off_update"
      end
      # resource path
      local_var_path = '/time-off/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TimeOffApi#time_off_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
