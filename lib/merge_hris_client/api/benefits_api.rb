...
module MergeHRISClient
  class BenefitsApi
    ...
    # @return [Benefit]
    def benefits_create(opts = {})
      data, _status_code, _headers = benefits_create_with_http_info(opts)
      data
    end
    ...
    def benefits_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'benefit']) 
    ...
    def benefits_destroy(id, opts = {})
      data, _status_code, _headers = benefits_destroy_with_http_info(id, opts)
      data
    end
    ...
    def benefits_destroy_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BenefitsApi.benefits_destroy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BenefitsApi.benefits_destroy"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BenefitsApi#benefits_destroy\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def benefits_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PaginatedBenefitList' 
    ...
    # @return [Benefit]
    def benefits_partial_update(id, opts = {})
      data, _status_code, _headers = benefits_partial_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PatchedBenefit] :patched_benefit 
    # @return [Array<(Benefit, Integer, Hash)>] Benefit data, response status code and response headers
    def benefits_partial_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BenefitsApi.benefits_partial_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BenefitsApi.benefits_partial_update"
      end
      # resource path
      local_var_path = '/benefits/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'patched_benefit']) 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BenefitsApi#benefits_partial_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Benefit] :benefit 
    # @return [Benefit]
    def benefits_update(id, opts = {})
      data, _status_code, _headers = benefits_update_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Benefit] :benefit 
    # @return [Array<(Benefit, Integer, Hash)>] Benefit data, response status code and response headers
    def benefits_update_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BenefitsApi.benefits_update ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BenefitsApi.benefits_update"
      end
      # resource path
      local_var_path = '/benefits/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BenefitsApi#benefits_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
