...
module MergeHRISClient
  class ExternalTargetFieldAPIResponse
    ...
    def self.openapi_types
      {
        :'benefit' => :'Array<ExternalTargetFieldAPI>',
        :'employer_benefit' => :'Array<ExternalTargetFieldAPI>',
        :'company' => :'Array<ExternalTargetFieldAPI>',
        :'employee_payroll_run' => :'Array<ExternalTargetFieldAPI>',
        :'employee' => :'Array<ExternalTargetFieldAPI>',
        :'employment' => :'Array<ExternalTargetFieldAPI>',
        :'location' => :'Array<ExternalTargetFieldAPI>',
        :'payroll_run' => :'Array<ExternalTargetFieldAPI>',
        :'team' => :'Array<ExternalTargetFieldAPI>',
        :'time_off' => :'Array<ExternalTargetFieldAPI>',
        :'time_off_balance' => :'Array<ExternalTargetFieldAPI>',
        :'bank_info' => :'Array<ExternalTargetFieldAPI>',
        :'pay_group' => :'Array<ExternalTargetFieldAPI>',
        :'group' => :'Array<ExternalTargetFieldAPI>',
        :'dependent' => :'Array<ExternalTargetFieldAPI>',
        :'timesheet_entry' => :'Array<ExternalTargetFieldAPI>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MergeHRISClient::ExternalTargetFieldAPIResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MergeHRISClient::ExternalTargetFieldAPIResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
