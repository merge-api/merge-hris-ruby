...
module MergeHRISClient
  class RemoteFieldAPIResponse
    ...
    def self.openapi_types
      {
        :'benefit' => :'Array<RemoteFieldAPI>',
        :'employer_benefit' => :'Array<RemoteFieldAPI>',
        :'company' => :'Array<RemoteFieldAPI>',
        :'employee_payroll_run' => :'Array<RemoteFieldAPI>',
        :'employee' => :'Array<RemoteFieldAPI>',
        :'employment' => :'Array<RemoteFieldAPI>',
        :'location' => :'Array<RemoteFieldAPI>',
        :'payroll_run' => :'Array<RemoteFieldAPI>',
        :'team' => :'Array<RemoteFieldAPI>',
        :'time_off' => :'Array<RemoteFieldAPI>',
        :'time_off_balance' => :'Array<RemoteFieldAPI>',
        :'bank_info' => :'Array<RemoteFieldAPI>',
        :'pay_group' => :'Array<RemoteFieldAPI>',
        :'group' => :'Array<RemoteFieldAPI>',
        :'dependent' => :'Array<RemoteFieldAPI>',
        :'timesheet_entry' => :'Array<RemoteFieldAPI>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MergeHRISClient::RemoteFieldAPIResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MergeHRISClient::RemoteFieldAPIResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
