...
module MergeHRISClient
  ...
  class BankInfo
    ...
    def hash
      [id, remote_id, created_at, modified_at, employee, account_number, routing_number, bank_name, account_type, remote_created_at, remote_was_deleted, field_mappings, remote_data].hash
    end
