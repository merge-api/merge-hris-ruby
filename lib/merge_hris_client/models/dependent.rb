...
module MergeHRISClient
  ...
  class Dependent
    ...
    def hash
      [id, remote_id, created_at, modified_at, first_name, middle_name, last_name, relationship, employee, date_of_birth, gender, phone_number, home_location, is_student, ssn, remote_was_deleted, field_mappings, remote_data].hash
    end
