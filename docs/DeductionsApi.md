...
api_instance = OpenapiClient::DeductionsApi.new
opts = {
  run_async: true, # Boolean | Whether or not third-party updates should be run asynchronously.
  deduction: OpenapiClient::Deduction.new # Deduction | 
}
...
opts = {
  run_async: true, # Boolean | Whether or not third-party updates should be run asynchronously.
  patched_deduction: OpenapiClient::PatchedDeduction.new # PatchedDeduction | 
}
...
begin
  result = api_instance.deductions_retrieve(id)
  p result
rescue OpenapiClient::ApiError => e
