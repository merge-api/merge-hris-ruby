...
opts = {
  ...
  employee_payroll_run_id: 'employee_payroll_run_id_example', # String | If provided, will only return earnings for this employee payroll run.
 ...
 **employee_payroll_run_id** | [**String**](.md)| If provided, will only return earnings for this employee payroll run. | [optional] 
