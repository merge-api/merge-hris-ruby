...
# Unit tests for MergeHRISClient::LinkedAccountCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeHRISClient::LinkedAccountCondition do
  let(:instance) { MergeHRISClient::LinkedAccountCondition.new }

  describe 'test an instance of LinkedAccountCondition' do
    it 'should create an instance of LinkedAccountCondition' do
      expect(instance).to be_instance_of(MergeHRISClient::LinkedAccountCondition)
    end
  end
