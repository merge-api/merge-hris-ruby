...
# Unit tests for OpenapiClient::PatchedBenefit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PatchedBenefit' do
  before do
    # run before each test
    @instance = OpenapiClient::PatchedBenefit.new
  end
  ...
  describe 'test an instance of PatchedBenefit' do
    it 'should create an instance of PatchedBenefit' do
      expect(@instance).to be_instance_of(OpenapiClient::PatchedBenefit)
    end
  end
