...
# Unit tests for MergeHRISClient::ConditionSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeHRISClient::ConditionSchema do
  let(:instance) { MergeHRISClient::ConditionSchema.new }

  describe 'test an instance of ConditionSchema' do
    it 'should create an instance of ConditionSchema' do
      expect(instance).to be_instance_of(MergeHRISClient::ConditionSchema)
    end
  end
