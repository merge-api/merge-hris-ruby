...
# Unit tests for MergeHRISClient::Team
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeHRISClient::Team do
  let(:instance) { MergeHRISClient::Team.new }

  describe 'test an instance of Team' do
    it 'should create an instance of Team' do
      expect(instance).to be_instance_of(MergeHRISClient::Team)
    end
  end
