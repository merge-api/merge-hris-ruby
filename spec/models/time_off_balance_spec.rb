...
# Unit tests for MergeHRISClient::TimeOffBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeHRISClient::TimeOffBalance do
  let(:instance) { MergeHRISClient::TimeOffBalance.new }

  describe 'test an instance of TimeOffBalance' do
    it 'should create an instance of TimeOffBalance' do
      expect(instance).to be_instance_of(MergeHRISClient::TimeOffBalance)
    end
  end
