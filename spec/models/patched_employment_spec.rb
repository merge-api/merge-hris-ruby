...
# Unit tests for OpenapiClient::PatchedEmployment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PatchedEmployment' do
  before do
    # run before each test
    @instance = OpenapiClient::PatchedEmployment.new
  end
  ...
  describe 'test an instance of PatchedEmployment' do
    it 'should create an instance of PatchedEmployment' do
      expect(@instance).to be_instance_of(OpenapiClient::PatchedEmployment)
    end
  end
