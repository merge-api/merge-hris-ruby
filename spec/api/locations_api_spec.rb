...
describe 'LocationsApi' do
  ...
  # unit tests for locations_partial_update
  ...
  # @return [Location]
  describe 'locations_partial_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for locations_update
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Location] :location 
  # @return [Location]
  describe 'locations_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
