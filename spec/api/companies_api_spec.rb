...
describe 'CompaniesApi' do
  ...
  # unit tests for companies_partial_update
  ...
  # @return [Company]
  describe 'companies_partial_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for companies_update
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Company] :company 
  # @return [Company]
  describe 'companies_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
