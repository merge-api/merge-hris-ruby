...
describe 'DocumentsApi' do
  ...
  # unit tests for documents_partial_update
  ...
  # @return [Document]
  describe 'documents_partial_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for documents_retrieve
  # Returns a &#x60;Document&#x60; object with the given &#x60;id&#x60;.
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Document]
  describe 'documents_retrieve test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for documents_update
  # @param id 
  # @param [Hash] opts the optional parameters
  # @option opts [Document] :document 
  # @return [Document]
  describe 'documents_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
